                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <form action="javascript:void(0);" enctype="multipart/form-data" method="post">
                                            <button formaction="<?= site_url('course/createcourse') ?>" type="summit" class="btn btn-block btn-success btn-lg">สร้างหลักสูตร</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="row justify-content-center">
                                    <div class="col-4 text-white p-lg-5">
                                        ...
                                        <br>
                                        <button type="button" class="btn btn-block btn-success btn-lg">สร้างหลักสูตร</button>
                                    </div>
                                </div>
                            </div>
                        </div>
